...
export const fetchProductDatas = createAsyncThunk('api/products', async (_, { rejectWithValue }) => {
    try {
...
export const fetchProductById = createAsyncThunk<Seller, string>('api/product', async (id, { rejectWithValue }) => {
    try {
...
export const createProduct = createAsyncThunk<GetProduct, UpdateProduct>('api/products/create', async (newProduct, { rejectWithValue }) => {
    try {
...
export const updateProduct = createAsyncThunk('api/products/update', async ({ id, updateProduct }: { id: string; updateProduct: UpdateProduct }, { rejectWithValue }) => {
    try {
